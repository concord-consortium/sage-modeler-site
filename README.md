...
Production releases are done using a manual GitHub Actions workflow. You specify which tag you want to release to production and the workflow copies that tag's `index-top.html` to `https://sagemodeler.concord.org/index.html`.
...
1. Test the staged release at https://sagemodeler.concord.org/index-staging.html
1. Update production by running the [Release Workflow](https://github.com/concord-consortium/sage-modeler-site/actions/workflows/release.yml) and entering the release version tag.
